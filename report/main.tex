...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{figures/stm32-escon-setup-overview.jpg}
\caption{Physical command setup used for STM32-to-ESCON testing. The Nucleo board supplies only low-current command signals; motor power and velocity control remain handled by the ESCON.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{figures/stm32-voltage-debug-sequence.jpg}
\caption{Voltage-isolation evidence from the STM32 debugging stage. The timed/blink test and button tests were used to confirm inactive and active command states before the ESCON inputs were connected.}
\end{figure}
